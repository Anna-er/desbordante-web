...
import {dependenciesFilterAtom, pieChartDataAtom, pieChartLoadingAtom} from '../store';


export const useСFDStatistics = () => {
    ...
    }, [taskIDChanged, setDependenciesFilter, setPieChartData, setPieChartLoading]);
